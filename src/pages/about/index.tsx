...
const About = () => {
  return (
    <div>
      ...
      <section
        id='overview'
        className='container py-6 flex flex-col-reverse gap-6 md:flex-row items-center'
      >
      ...
      <section
        id='mission'
        className='container py-6 flex flex-col-reverse gap-6 md:flex-row-reverse items-center'
      >
        <div className='flex flex-col items-start justify-center gap-6 w-full'>
          <h2 className='text-2xl md:text-2xl lg:text-[40px] text-left font-semibold text-primary'>
            Mission and Vision
