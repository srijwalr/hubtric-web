  ...
  return (
    <div className="our-team flex flex-col md:flex-row gap-8 px-4 py-16 bg-black text-white">
      <div className="container mx-auto flex flex-col lg:flex-row">
        <div className="image-section mr-8 mb-8 lg:mb-0 flex flex-col md:flex-row justify-center lg:justify-start align-center lg:align-start gap-10">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <p className=" text-sm 2xl:text-md text-center">{member.designation}</p>
              {/* <p className="text-sm text-center">{member.country}</p> */}
        ...
        <div className="text-section w-full lg:w-1/2 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
          <h2 className="text-sm 2xl:text-md mb-4 font-light">Our Team</h2>
          ...
          <p className="text-sm 2xl:text-md mb-4 font-light">
